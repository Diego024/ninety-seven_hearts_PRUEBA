...
<div class="container" id="table-container">
    <div class="search-container">
        ...
        <a href="../../app/reports/dashboard/inventario.php" target="_blank" class="btn waves-effect amber tooltipped" data-tooltip="Reporte de productos por categoría"><i class="material-icons">assignment</i></a>
